...
est_1a <- sum(poststrat_data$N*predict_1a)/sum(poststrat_data$N)
...
predict_poststrat <- posterior_predict(fit, newdata=X_population)
...
#' **More complicated example with two predictors**<br>
#' 
