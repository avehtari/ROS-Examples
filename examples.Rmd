...
- For R programming basics see Appendix A of Regression and Other Stories. If you want to learn more, see our recommendations for [R programming and visualization with R](R_visualization.html).

- The folders below (ending /) point to the code (.R and .Rmd)
  and `data` folders (.csv or .txt + codebooks) in github, and .html -files
...
- Most examples have cleaned data in .csv file in `data` subfolder
  ...
  the setup code). Most `data` folders hve also some codebook explaining
  the column names.
