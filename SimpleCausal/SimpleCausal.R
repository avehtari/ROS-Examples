...
pdf(here("SimpleCausal/figs","overview_1a.pdf"), height=3.5, width=4.5)
...
pdf(here("SimpleCausal/figs","overview_1b.pdf"), height=3.5, width=4.5)
par(mar=c(3, 3, 1.5, 1), mgp=c(1.7, .5, 0), tck=-.01)
...
pdf(here("SimpleCausal/figs","overview_2a.pdf"), height=3.5, width=4.5)
par(mar=c(3, 3, 1.5, 1), mgp=c(1.7, .5, 0), tck=-.01)
...
pdf(here("SimpleCausal/figs","overview_2b.pdf"), height=3.5, width=4.5)
par(mar=c(3, 3, 1.5, 1), mgp=c(1.7, .5, 0), tck=-.01)
...
pdf(here("SimpleCausal/figs","overview_3.pdf"), height=3.5, width=4.5)
par(mar=c(3, 3, 1.5, 1), mgp=c(1.7, .5, 0), tck=-.01)
