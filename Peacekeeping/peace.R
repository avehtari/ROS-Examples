setwd("~/AndrewFiles/books/regression.and.other.stories/Examples/Peacekeeping")

library("foreign")
peace <- read.dta("pk&pkept_old.dta")

#write.csv (badness, "badness.csv")
#write.csv (peace, "peace.csv")

# badness regression
#cox.0 <- coxph (faildate ~ infst + polityst + wartype + sambsec...)
#
#hazard1
#pcw
